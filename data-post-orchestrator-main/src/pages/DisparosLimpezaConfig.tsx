          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-4">
              <Button
                variant="ghost"
                size="sm"
                onClick={() => navigate("/disparos/limpeza")}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <CardDescription className="text-gray-600">
                      Personalize a mensagem de lembrete para pacientes
                    </CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="p-6 space-y-6">
                <div className="space-y-2">
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                    <p className="text-xs text-blue-700 font-medium mb-2">Variáveis disponíveis:</p>
                    <div className="flex flex-wrap gap-2">
                      <code className="bg-white px-2 py-1 rounded text-xs border border-blue-300">{"{nome}"}</code>
                      <code className="bg-white px-2 py-1 rounded text-xs border border-blue-300">{"{data_limpeza}"}</code>
                      <code className="bg-white px-2 py-1 rounded text-xs border border-blue-300">{"{telefone}"}</code>
                    </div>
                  </div>
                </div>
              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600">Disparos</span>
              ...
              <CardContent className="p-6 space-y-4">
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
                  <p className="text-xs text-gray-600 text-center">
                    O teste enviará uma mensagem para verificar se a configuração está funcionando corretamente.
                  </p>
                </div>
              </CardContent>
            </Card>
...
export default DisparosLimpezaConfig;
