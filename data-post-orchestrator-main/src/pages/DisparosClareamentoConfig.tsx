...
import { ArrowLeft, Settings, Clock, MessageSquare, Play, Calendar, CheckCircle, AlertCircle, Sparkles, Save, Send } from "lucide-react";
...
const DisparosClareamentoConfig = () => {
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-4">
              <Button
                variant="ghost"
                size="sm"
                onClick={() => navigate("/disparos/clareamento")}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <CardDescription className="text-gray-600">
                      Personalize a mensagem de lembrete para tratamentos
                    </CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="p-6 space-y-6">
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    placeholder="Digite sua mensagem de clareamento aqui..."
                  />
                  <div className="bg-amber-50 border border-amber-200 rounded-lg p-3">
                    <p className="text-xs text-amber-700 font-medium mb-2">Variáveis disponíveis:</p>
                    <div className="flex flex-wrap gap-2">
                      <code className="bg-white px-2 py-1 rounded text-xs border border-amber-300">{"{nome}"}</code>
                      <code className="bg-white px-2 py-1 rounded text-xs border border-amber-300">{"{data_clareamento}"}</code>
                      <code className="bg-white px-2 py-1 rounded text-xs border border-amber-300">{"{telefone}"}</code>
                    </div>
                  </div>
                </div>
              ...
              <CardContent className="p-6 space-y-4">
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
                  <p className="text-xs text-gray-600 text-center">
                    O teste enviará uma mensagem de lembrete para verificar se a configuração está funcionando corretamente.
                  </p>
                </div>
              </CardContent>
            </Card>
...
export default DisparosClareamentoConfig;
