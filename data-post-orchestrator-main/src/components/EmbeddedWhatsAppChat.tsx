...
import { Send, MessageSquare, Download, Loader2 } from "lucide-react";
...
const SUPABASE_FN_URL = 'https://wtqhpovjntjbjhobqttk.supabase.co/functions/v1';
...
export const EmbeddedWhatsAppChat = ({ contactName, contactPhone }: EmbeddedWhatsAppChatProps) => {
